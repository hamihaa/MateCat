...
class INIT {
    ...
    public static $MAX_UPLOAD_FILE_SIZE         = 209715200;         // 200 * 1024 * 1024;  // bytes
    ...
    public static $FILTERS_API_KEY                   = "Register to https://rapidapi.com/translated/api/matecat-filters/details to obtain your Rapidapi Key";
